...
import { getDailyRecords, deleteDailyRecord, getPatientProfiles } from '../../lib/dummyDatabase'
import { DailyRecord, PatientProfile } from '../../types'
import { Plus, Search, Activity, Calendar, TrendingUp, CreditCard as Edit, Trash2, User } from 'lucide-react'
